...
//int sub_401135(cancellation_token_registration** thisx);
...
IVirtualProcessorRoot* sub_41FE85(int thisx);
...
int sub_4238DE(int thisx, ISchedulerProxy* a2);
...
IVirtualProcessorRoot* sub_425B40(IVirtualProcessorRoot* thisx, char a2);
...
//unsigned int GetQueueLength(ISchedulerProxy* thisx);
//struct IExecutionContext* GetExecutingContext(IVirtualProcessor* thisx);
//unsigned int GetExecutionResourceId(IVirtualProcessor* thisx);
...
_DWORD* sub_446D6F(_DWORD* thisx, IScheduler* a2);
...
UINT 读取配置文件(int thisx, LPCSTR lpFileName);
...
//Concurrency::details::_UnrealizedChore* sub_45612D(_DWORD* thisx, char a2, char a3, int a4, int a5, int a6);
...
int sub_464229(_BYTE* thisx, IScheduler* a2);
int __stdcall sub_464550(IVirtualProcessorRoot* a1, int a2);
...
_DWORD* sub_465B44(_DWORD* thisx, IScheduler* a2);
...
int sub_466A41();
BOOL __stdcall sub_466BEC(int a1, IVirtualProcessorRoot* a2);
...
int sub_474032(char* thisx, IScheduler* a2);
...
int __cdecl 设置_WNDCLASSA(HINSTANCE hInstance);//对程序实例做一些配置，不用管
...
//_UnrealizedChore* sub_488FA2(void* thisx,unsigned __int8 a2,unsigned __int8 a3,int a4,int a5,int a6);
...
//unsigned __int16  GetGroup(Concurrency::details::HardwareAffinity* thisxx);
