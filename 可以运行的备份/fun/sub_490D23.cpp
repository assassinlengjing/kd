...
int __fastcall sub_490D23(int a1)
{
    ...
    if (!*(_DWORD*)(a1 + 176))
    {
        sub_4641FE((_DWORD*)byte_4B9B10, *(_DWORD*)(a1 + 96), *(_DWORD*)(a1 + 100), *(_DWORD*)(a1 + 104), (int)v28);
        v30 = v28[0];
        v29 = v28[1];
        v35 = sub_446497((_DWORD*)byte_4B9B10, *(_DWORD*)(a1 + 96) / 100, *(_DWORD*)(a1 + 100) / 100);
        v36 = sub_4464F6((_DWORD*)byte_4B9B10, *(_DWORD*)(a1 + 96) / 800, *(_DWORD*)(a1 + 100) / 800);
        v37 = (_BYTE*)sub_4741F8((int)byte_4B9B10, *(_DWORD*)(a1 + 96) / 800, *(_DWORD*)(a1 + 100) / 800);
        ...
        for (i = 0; ; ++i)
        {
            ...
            if ((unsigned __int16)word_4B92EC > v22)
            {
                ...
                for (j = 0; j < v24; ++j)
                {
                    ...
                    result = sub_48FB00((int)v23, (int)&Src, (int)byte_4BDC60, &Src, yTop);
                }
                if (dword_4B93A8)
                {
                    v41 = 0;
