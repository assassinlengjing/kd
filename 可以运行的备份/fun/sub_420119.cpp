    ...
    if (result > 0 && result < 320)
    {
        if (sub_425FF0(*(_DWORD**)(thisx + 124)))
        {
            ...
            if (*(_BYTE*)(thisx + 87))
            {
                if (sub_494AA9(v33, 1))
                {
                    result = sub_4655EF((_DWORD*)byte_4B9B10, *(_DWORD**)(thisx + 124), 32, 0);
                    if (result)
                    {
                        *(_BYTE*)(thisx + 143) = 1;
                        return result;
            ...
            {
                result = sub_4655EF((_DWORD*)byte_4B9B10, *(_DWORD**)(thisx + 124), 128, 1);
                if (result)
                {
                    *(_BYTE*)(thisx + 144) = 1;
                    return result;
            ...
            && sub_4655EF((_DWORD*)byte_4B9B10, *(_DWORD**)(thisx + 124), 32, 0))
        {
            *(_BYTE*)(thisx + 85) = 2;
        }
        if (sub_425FF0(*(_DWORD**)(thisx + 124)))
        ...
        if (sub_425D30(*(_DWORD**)(thisx + 124)) || sub_425FF0(*(_DWORD**)(thisx + 124)))
        {
            ...
            if (result)
            {
                ...
                if (!result)
                {
                    ...
                    {
                        if (sub_426930(*(_DWORD**)(thisx + 124)) >= 0 ? sub_4655EF((_DWORD*)byte_4B9B10, *(_DWORD**)(thisx + 124), 64, 1) : sub_4655EF((_DWORD*)byte_4B9B10, *(_DWORD**)(thisx + 124), 128, 1))
                            *(_BYTE*)(thisx + 142) = 1;
                    }
                    if (sub_41BA53(*(_DWORD*)(thisx + 124), 0x25u, 0)
                        && rand() % 100 < 5
                        && sub_4655EF((_DWORD*)byte_4B9B10, *(_DWORD**)(thisx + 124), 80, 1))
                    {
                        *(_BYTE*)(thisx + 142) = 1;
                        *(_BYTE*)(thisx + 143) = 1;
                    }
        ...
        else
        {
            if (SchedulerProxy == 13
                ...
                && rand() % 100 < 20
                && sub_4655EF((_DWORD*)byte_4B9B10, *(_DWORD**)(thisx + 124), 128, 1))
            {
            ...
            if (SchedulerProxy == 10
                ...
                && sub_457731((_DWORD*)byte_4B9B10, *(_DWORD**)(thisx + 124)))
            {
                *(_BYTE*)(thisx + 84) = 1;
            }
            ...
            if (SchedulerProxy == 91)
                *(_BYTE*)(thisx + 143) = sub_425ED0(*(_DWORD**)(thisx + 124)) < 37
                || !sub_4655EF((_DWORD*)byte_4B9B10, *(_DWORD**)(thisx + 124), 320, 1);
            ...
            {
                if (v32 == 3 || v32 && sub_4655EF((_DWORD*)byte_4B9B10, *(_DWORD**)(thisx + 124), 32, 0))
                {
                    *(_BYTE*)(thisx + 143) = 0;
                    if (v32 == 3)
                        *(_BYTE*)(thisx + 145) = 1;
        ...
        if (*(_DWORD*)(thisx + 128))
        {
            v41 = sub_4464D3((int)byte_4B9B10, v40 / 800, v39 / 800);
