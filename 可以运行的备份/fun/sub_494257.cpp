...
int sub_494257(int thisx, int a2, int a3, int a4)
{
    ...
    else if (a2 && !a4)
    {
        ...
        *(_BYTE*)(thisx + 69) = 1;
        ...
        {
        case 8:
            result = sub_43FFC3((_DWORD*)dword_4BDB28, dword_4B9ABC, -1, 100, 100, 0);
            break;
        case 9:
            result = sub_43FFC3((_DWORD*)dword_4BDB28, dword_4B9AC0, -1, 100, 100, 0);
            break;
        case 0xA:
        case 0xD:
            result = sub_43FFC3((_DWORD*)dword_4BDB28, dword_4B9A14, -1, 100, 100, 0);
            break;
        default:
            return result;
        }
