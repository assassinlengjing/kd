...
int sub_41D61F(int thisx);//this，hero头部，返回战斗前初始化的生命值数值
...
UINT sub_450FF8(int thisx, LPCSTR lpFileName);//读取配置文件
...
int sub_4917E7(int a1, double st6_0, double st7_0, int a3, int a4, int a5, int a6);
...
int __cdecl messagebox(LPCSTR lpText);//sub_499850
