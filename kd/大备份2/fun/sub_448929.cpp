...
LABEL_4:
    ...
    if (*(_BYTE*)(a1 + 2544) || *(_DWORD*)(a1 + 16136))
    {
        if (*(int*)(a1 + 16136) <= 0)
        {
            if (*(_BYTE*)(a1 + 2544) == 1)
            {
                ...
                if (((*(unsigned __int8*)(a1 + 2545) / 2) & 0x80000001) != 0)
                    sub_49EDC1((int)byte_4BDC60, 0, (int*)&v38, 0xFFFFFF);
                else
        ...
        else
        {
            ...
            sub_49EDC1((int)byte_4BDC60, v28, (int*)&rc, 0);
        }
    }
    else
    {
    ...
    if (*(_DWORD*)(a1 + 2500))
    {
        ...
        *(_DWORD*)(a1 + 2504) = *(_DWORD*)(a1 + 2504) == 0;
        ...
        if (*(_DWORD*)(a1 + 2504))
            result = (unsigned __int16*)sub_440B78(dword_4BDB28);
        else
            result = (unsigned __int16*)sub_440BC2(dword_4BDB28);
    }
    v120 = 1;
    for (i = 0; i < 8; ++i)
    {
    ...
    if (dword_4B9974 || v120)
    {
        ...
        sub_49EF70((int)byte_4BDC60, (int*)&v36, 0, 0, 0, 0x20u);
