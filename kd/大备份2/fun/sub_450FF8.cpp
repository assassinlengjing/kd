...
UINT sub_450FF8(int thisx, LPCSTR lpFileName)
{
    ...
    *(_BYTE*)(thisx + 2452) = GetPrivateProfileIntA(aKkconfig_9, aHitsameteam_0, 0, lpFileName);
    byte_4B99E9 = GetPrivateProfileIntA(aDirectdrawconf_0, aFullscreen, 1, lpFileName);
    ...
    for (nDefault = 0; nDefault < 8; ++nDefault)
    {
        ...
        sub_47652C((_DWORD*)&byte_4B9410[108 * nDefault], v12);
    ...
    for (nDefault = 0; nDefault < 8; ++nDefault)
    {
        for (k = 0; k < 11; ++k)
        {
            sub_4768A2(&byte_4B9410[108 * nDefault], k, *(_BYTE*)(thisx + 11 * nDefault + k + 11176));
            result = k + 1;
        }
        for (m = 0; m < 11; ++m)
        {
            sub_47690D(&byte_4B9410[108 * nDefault], m, *(_BYTE*)(thisx + 11 * nDefault + m + 11264));
            result = m + 1;
        }
    }
    return result;
