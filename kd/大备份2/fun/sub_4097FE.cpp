...
void sub_4097FE(int a1, double a2, double a3, double a4)
{
    ...
    if (*(_DWORD*)(a1 + 444) == 1)
    {
        ...
        *(_DWORD*)(a1 + 264) = 83;
        ...
        {
            sub_4239D3(a1, -100);
            sub_473DA5((int*)byte_4B9B10, 60, a1);
            sub_43FFC3((int*)dword_4BDB28, dword_4B9AE0, -1, 100, 100, 0);
            sub_442863(v70);
            v72 = 0;
            v71 = 19;
            v70[1] = -16;
            v73 = a1;
            sub_4561A5((char*)byte_4B9B10, (int)v70);
        }
    }
    if (*(int*)(a1 + 428) > 83)
    {
    ...
    case 7:
        if (*(_DWORD*)(a1 + 444) == 1)
        {
            sub_43FFC3((int*)dword_4BDB28, dword_4B9A04, -1, 100, 100, 0);
            *(_DWORD*)(a1 + 436) = 0;
            ++* (_BYTE*)(a1 + 238);
        }
        ...
        else if (*(_BYTE*)(a1 + 188) == 1)
        {
            *(_BYTE*)(a1 + 212) = 1;
            ...
            if (*(_DWORD*)(a1 + 444) == 28)
                *(_DWORD*)(a1 + 444) = 0;
            if (!(*(_DWORD*)(a1 + 444) % 10))
                sub_43FFC3((int*)dword_4BDB28, dword_4B9AC8, -1, 100, 100, 0);
        }
        ...
        if (*(_DWORD*)(a1 + 304))
        {
            ...
            *(_BYTE*)(a1 + 213) = -1;
            ...
            if (*(_DWORD*)(a1 + 444) == 8)
            {
                ...
                sub_43FFC3((int*)dword_4BDB28, dword_4B9A0C, -1, 100, 100, 0);
            }
            if (*(int*)(a1 + 444) >= 20)
                *(_DWORD*)(a1 + 432) = 69;
        ...
        if (*(int*)(a1 + 444) < 30 && *(_DWORD*)(a1 + 304))
        {
            if (*(_DWORD*)(a1 + 444) == 1)
            {
                *(_DWORD*)(a1 + 424) = *(_DWORD*)(a1 + 424) == 0;
                ...
                sub_43FFC3((int*)dword_4BDB28, dword_4B9A24, -1, 100, 100, 0);
            }
            *(_BYTE*)(a1 + 212) = 0;
            if (*(int*)(a1 + 444) >= 8)
            {
            ...
            else
            {
                *(_WORD*)(a1 + 204) = (*(_DWORD*)(a1 + 444) - 1) / 5 % 3 + 53;
                if ((*(_DWORD*)(a1 + 444) - 1) % 15 == 5)
                    sub_43FFC3((int*)dword_4BDB28, dword_4B9A5C, -1, 100, 100, 0);
            }
                            ...
                            if (*(int*)(a1 + 444) >= 41)
                            {
                                if (*(int*)(a1 + 444) >= 49)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        v56 = v57;
                                        v54 = -100 * sub_446497((int*)byte_4B9B10, v55 / 100, *(_DWORD*)(a1 + 332) / 100);
    ...
    case 0x3A:
        ...
        if (*(_BYTE*)(a1 + 195))
        {
            ...
            case 3:
                ...
                if (*(_DWORD*)(a1 + 444) == 16)
                {
                    sub_43FFC3((int*)dword_4BDB28, dword_4B9A18, -1, 100, 100, 0);
                    *(_DWORD*)(a1 + 304) = 0;
                }
                if (*(int*)(a1 + 444) >= 44)
                    *(_DWORD*)(a1 + 432) = 4;
    ...
    case 0x27:
        *(_BYTE*)(a1 + 212) = 0;
        ...
        if (*(_DWORD*)(a1 + 440))
        {
            ...
            {
                v47 = sub_446465((char*)byte_4B9B10);
                sub_446442((int*)byte_4B9B10, a1, (int)&v45);
                v49 = 800 * sub_44647E((char*)byte_4B9B10);
                if (*(int*)(a1 + 332) >= 0)
                {
                ...
                {
                    *(_DWORD*)(a1 + 328) += v46;
                    v48 = sub_446497((int*)byte_4B9B10, *(_DWORD*)(a1 + 328) / 100, *(_DWORD*)(a1 + 332) / 100);
                } while (v48 == 1020);
                *(int*)(a1 + 372) /= 2;
                *(_DWORD*)(a1 + 336) = -48000;
                *(_DWORD*)(a1 + 348) = 0;
        ...
        {
            sub_446442((int*)byte_4B9B10, a1, (int)v50);
    ...
    if (*(_DWORD*)(a1 + 428) != 48)
    {
        ...
        default:
            ...
            case 0x44:
                ...
                *(_DWORD*)(a1 + 304) = 0;
                if (*(_DWORD*)(a1 + 444) == 1)
                    sub_43FFC3((int*)dword_4BDB28, dword_4B9A08, -1, 100, 100, 0);
            ...
            case 0x4F:
                ...
                *(_BYTE*)(a1 + 176) = *(_DWORD*)(a1 + 444) / 5 % 2;
                if (*(_DWORD*)(a1 + 444) == 3)
                {
                    sub_43FFC3((int*)dword_4BDB28, dword_4B9A30, -1, 100, 100, 0);
                    *(_BYTE*)(a1 + 177) = 1;
                }
                if (*(int*)(a1 + 444) >= 80)
                {
                        ...
                        if (*(_DWORD*)(a1 + 444) == 1)
                        {
                            ...
                            *(_DWORD*)(a1 + 172) = 0;
                            ...
                            if ((v30 == 1 || !v30 || v30 == 4) && byte_4B99CB && !*(_DWORD*)(a1 + 392))
                            {
                                ...
                                v27 = sub_446497((int*)byte_4B9B10, v25, v26);
                                for (i = 0; i < 22; ++i)
                                    v24[i] = 1;
                                v20 = sub_465AFA((unsigned char*)byte_4B9B10);
                                v29 = byte_4B999A != 0;
                                v23 = 22;
                                if (v30 == 4 && !(rand() % 2))
                                {
                                ...
                                v28 = k + 1;
                                sub_456A74((char*)byte_4B9B10, (int)&v25);
                            }
                        }
                    }
