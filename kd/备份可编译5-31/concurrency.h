...
struct ios;
		...
		static struct IExecutionContext* GetExecutingContext(VirtualProcessor* thisx);
		static unsigned int GetExecutionResourceId(VirtualProcessor* thisx);
		...
		static void SetCompletionList(UMSThreadScheduler* thisx, struct IUMSCompletionList* a2);
