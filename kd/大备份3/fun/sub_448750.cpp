...
int sub_448750(int thisx)
{
    ...
    *(_BYTE*)(thisx + 2562) = 0;
    ...
    for (i = 0; i < (unsigned __int8)unk_4B9986; ++i)
    {
        ...
        *(_BYTE*)(v4 + thisx + 2580) = MarkedForDetachment((_BYTE*)unk_4B92E0);
        if (v4 < 0)
    ...
    for (j = (unsigned __int8)unk_4B9986; j < (unsigned __int8)unk_4B9985; ++j)
    {
        v3 = sub_4576F0(j);
        *(_WORD*)(thisx + 2 * v3 + 2564) = v5;
        *(_BYTE*)(v3 + thisx + 2580) = MarkedForDetachment((_BYTE*)(36 * v5 + unk_4B92E0));
        v5 += 4;
        if (v5 >= 0x10u)
            v5 = 1;
    }
