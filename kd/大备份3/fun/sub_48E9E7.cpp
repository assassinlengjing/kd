...
int sub_48E9E7(_DWORD* thisx)
{
    ...
    if (v7)
    {
        *((_BYTE*)thisx + thisx[5] + 36) = ((unsigned __int8)unk_4B9990 + v7 + *((unsigned __int8*)thisx + thisx[5] + 36))
            % (unsigned __int8)unk_4B9990;
        v9 = 3;
        sub_43FFC3((_DWORD*)unk_4BDB28, unk_4B99FC[0], -1, 100, 100, 0);
    }
    else if (v6)
    {
        thisx[5] = ((unsigned __int8)unk_4B9986 + v6 + thisx[5]) % (unsigned __int8)unk_4B9986;
        v9 = 4;
        sub_43FFC3((_DWORD*)unk_4BDB28, unk_4B99FC[0], -1, 100, 100, 0);
    }
    else if (v5)
