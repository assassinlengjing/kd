...
int *__cdecl _NMSG_WRITE(DWORD NumberOfBytesWritten)
{
  ...
  while ( (int)result < (int)&unk_4B8760 );
  v3 = 2 * v1;
  if ( NumberOfBytesWritten == unk_4B86D0[2 * v1] )
  {
    result = (int *)unk_4CB234;
    if ( unk_4CB234 == 1 || !unk_4CB234 && unk_4B8304 == 1 )
    {
      v5 = (const char **)&(&unk_4B86D4)[v3];
      v10 = 0;
    ...
    else if ( NumberOfBytesWritten != 252 )
    {
      ...
      strcat(Destination, "\n\n");
      strcat(Destination, ((const char*)(& unk_4B86D4)[v3]));
