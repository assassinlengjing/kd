...
int __cdecl sub_47E5AC(HINSTANCE hInstance, int nCmdShow)
{
    ...
    v7 = 320;
    v8 = 240;
    v9 = 100 * (unsigned __int8)unk_4B99E7;
    unk_4B91D0 = unk_4B99E8;
    unk_4B999A = 4;
    v10 = hInstance;
    if (unk_4B99E9)
    {
    ...
    if (sub_43F7F7((long*)unk_4BDB28, (int)hWnd))
    {
        sub_49DB43(v4);
        v4[0] = (int)hWnd;
        v4[4] = (unsigned __int8)unk_4B99E9;
        v4[1] = v7;
        v4[2] = v8;
        v5 = 1;
        v6 = unk_4B91D0;
        v4[3] = (v9 << 8) / 100;
        if (sub_4998E0((int)unk_4BDC60, (int)v4))
        {
            sub_474DB0(unk_4BDC60, 1);
            return 1;
        }
        else
        {
    ...
    {
        MessageBoxA(hWnd, &unk_4B6B34, aError_38, 0);
        return 0;
    }
}
