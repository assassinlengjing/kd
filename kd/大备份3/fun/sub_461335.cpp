...
int sub_461335(int thisx)
{
    ...
    *(_DWORD*)(thisx + 2528) = *(unsigned __int8*)(thisx + 13124);
    ...
    for (i = 0; i < 6; ++i)
    {
        ...
        sub_47B7ED(v10 + 16, v9 + 8, String, 0, unk_4B9248);
        if (sub_4611A8((_BYTE*)thisx, i, (int)v12))
        {
            *(_WORD*)(thisx + 2 * i + 2564) = 1;
            ...
            sub_47B91A(v10 + 88, v9 + 8, (LPCSTR)&unk_4B2654, 0, unk_4B9248);
            v7 = unk_4B9248;
            v2 = sub_4266D0(v13);
            ...
            if (v14)
            {
                if (v14 < 0x11u)
                {
                    wsprintfA(String, (LPCSTR)&unk_4B1F22, v14 + 1);
                    sub_47B7ED(v10 + 8, v9 + 20, String, 0, unk_4B9248);
                    sub_47B91A(v10 + 24, v9 + 20, a2d_5, 0, unk_4B9248);
                }
                else
                {
                    sub_47B91A(v10 + 8, v9 + 20, (LPCSTR)&unk_4B1B38, 0, unk_4B9248);
                }
            }
            else
            {
                sub_47B91A(v10 + 8, v9 + 20, &unk_4B1B2C, 0, unk_4B9248);
            }
            wsprintfA(String, "%2dPOINT", v15);
            sub_47B7ED(v10 + 8, v9 + 32, String, 0, unk_4B9248);
            v3 = sub_4750D0(v12);
            wsprintfA(String, "LV%2d", v3);
            sub_47B7ED(v10 + 88, v9 + 20, String, 0, unk_4B9248);
            v4 = sub_4750D0(v13);
            wsprintfA(String, "LV%2d", v4);
            sub_47B7ED(v10 + 88, v9 + 32, String, 0, unk_4B9248);
        }
        else
        {
            *(_WORD*)(thisx + 2 * i + 2564) = 0;
            sub_47B91A(v10 + 48, v9 + 8, (LPCSTR)&unk_4B0C10, 0, unk_4B9248);
        }
    }
    if (*(_BYTE*)(thisx + 2562))
        result = sub_47B91A(16, 208, (LPCSTR)&unk_4B2DB2, 0, unk_4B9248);
    else
        result = sub_47B91A(16, 208, (LPCSTR)&unk_4B1B52, 0, unk_4B9248);
