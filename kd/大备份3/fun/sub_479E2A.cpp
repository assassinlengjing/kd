...
int sub_479E2A()
{
    ...
    if (sub_482C74((int)v6, aDataCheergirld))
    {
        ...
        if (unk_4B92D4)
            (**(void(__thiscall***)(int, int))unk_4B92D4)(unk_4B92D4, 3);
        v14 = unk_4B92D8;
        Block = (_DWORD*)operator new(84 * unk_4B92D8 + 4);
        LOBYTE(v15) = 1;
        if (Block)
        {
            *Block = v14;
        ...
        if (sub_482C74((int)v10, aDemoKkResult1T_0))
        {
            ...
            {
                for (j = 0; j < 4; ++j)
                    sub_47ECA0((_WORD*)(84 * i + unk_4B92D4), j, v11[j]);
                sub_43E7AA(84 * i + unk_4B92D4, (_DWORD)v6, (int)v7);
            }
            LOBYTE(v15) = 0;
            sub_482C2F(v10);
            v15 = -1;
