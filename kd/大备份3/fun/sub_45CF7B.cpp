...
int sub_45CF7B(int thisx)
{
    ...
    *(_DWORD*)v29 = unk_4B2A18;
    ...
    for (i = 0; i < 2; ++i)
    {
        ...
        sub_47B91A(v22, v21 + 16, v29, 0, unk_4B9248);
        if (v26[0])
            wsprintfA(String, "+%2d", (unsigned __int16)v26[0]);
        else
            wsprintfA(String, asc_4B2A88);
        sub_47B7ED(v22 + 40, v21 + 16, String, 0, unk_4B9248);
        for (j = 1; j < 11; ++j)
        {
            sub_47B91A(80 * ((j - 1) / 5) + v22, v21 + 16 * ((j - 1) % 5) + 32, &v29[13 * j], 0, unk_4B9248);
            if (v26[j])
                wsprintfA(String, "+%2d", (unsigned __int16)v26[j]);
            else
                wsprintfA(String, asc_4B2A94);
            sub_47B7ED(v22 + 80 * ((j - 1) / 5) + 40, v21 + 16 * ((j - 1) % 5) + 32, String, 0, unk_4B9248);
        }
    ...
    return sub_47B91A(16, 208, &unk_4B2AA0, 0, unk_4B9248);
}