...
unsigned __int16* sub_46E35A(int thisx, double a2, double a3, double a4)
{
    ...
    v52 = (unsigned __int8)unk_4B9986;
    for (i = 0; i < v52; ++i)
        sub_477F0C(i);
    for (j = 0; j < 4; ++j)
    {
                ...
                if (!*(_BYTE*)(j + thisx + 2612) || *(_BYTE*)(thisx + 2 * j + 2588) == 2)
                {
                    ...
                    for (k = 0; k < 6; ++k)
                    {
                        if (*(_BYTE*)(j + thisx + 2612) != 1 || k != *(unsigned __int8*)(thisx + 2 * j + 2580))
                        {
                            ...
                            v5 = *(__int16*)(v30 + 8);
                            v6 = v5 * ((unsigned __int8)sub_426670((char*)(36 * *(_DWORD*)v30 + unk_4B92E0)) + v5);
        ...
        if (*(_BYTE*)(thisx + 2516) != 2)
        {
                ...
                ++m)
            {
                ...
                if (v28 < 6)
                {
                    ...
                    v26 = *(_DWORD*)v24;
                    v23 = *(_BYTE*)(v24 + 4);
                    v25 = (unsigned __int8)sub_401710((_BYTE*)(unk_4B92E0 + 36 * *(_DWORD*)v24));
                }
                sub_4A1307(8 * (m + 2 * j) + 4952720, (Concurrency::details::HardwareAffinity*)(8 * j + 4952656));
                sub_485E5A((int)unk_4B93A4 + 24 * v25, (unsigned __int16*)(8 * (m + 2 * j) + 4952720));
