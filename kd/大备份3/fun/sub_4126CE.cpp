...
void sub_4126CE(int thisx, double a2, double a3, double a4)
{
    ...
    *(_DWORD*)(thisx + 368) = 0;
    ...
    if (!*(_DWORD*)(thisx + 392) && *(_DWORD*)(thisx + 336) == -102000)
    {
        ...
        for (i = 0; i < v79; ++i)
        {
            ...
            {
                v77 = sub_446497(unk_4B9B10, 8 * j, 8 * i);
                if (v77 != 1020)
                {
    ...
    v103 = 100 * sub_446497(unk_4B9B10, *(_DWORD*)(thisx + 328) / 100, *(_DWORD*)(thisx + 332) / 100);
    ...
    *(_DWORD*)(thisx + 208) = 0;
    ...
    LOBYTE(v108) = sub_4464F6(unk_4B9B10, *(_DWORD*)(thisx + 328) / 800, *(_DWORD*)(thisx + 332) / 800);
    ...
    if (v63 <= 0 || v63 >= v65 - 1 || v62 <= 0 || v62 >= v64)
    {
        ...
        if (sub_4464F6(unk_4B9B10, v63, v62) == 7)
            v112 = 1;
    }
    v96 = 0;
    if (!v112)
    {
        ...
        *(_DWORD*)(thisx + 332) = v56;
        v55 = 0;
        if (v58 < 8 || v58 >= v61 - 8 || !*(_DWORD*)(thisx + 164) || sub_425CD0(unk_4B9B10) != 3)
        {
            if (v57 < 8)
            {
    ...
    v94 = 0;
    v102 = 0;
    v103 = 100 * sub_446497(unk_4B9B10, v99, v89);
    v91 = *(_DWORD*)(thisx + 336) + v103 - v102;
    if (v103 >= 102000 || (!*(_DWORD*)(thisx + 392) || v91 > 0) && (*(_DWORD*)(thisx + 392) || v91 > 799))
    {
        v90 = 1;
        LOBYTE(v107) = sub_4464F6(unk_4B9B10, v99 / 8, v89 / 8);
        v101 = sub_4744A9(unk_4B9B10, v99 / 8, v89 / 8);
    }
    else
    {
        *(_DWORD*)(thisx + 332) += v100;
    ...
    v113 = 100 * sub_446497(unk_4B9B10, v99, v92);
    v103 = 100 * sub_446497(unk_4B9B10, v98, v92);
    ...
    while (v105)
    {
        v103 = 100 * sub_446497(unk_4B9B10, v97, v92);
        v53 = sub_4464F6(unk_4B9B10, v97 / 8, v92 / 8);
        ...
        else
        {
            v109 = 1;
            LOBYTE(v110) = v53;
            LOWORD(v106) = sub_4744A9(unk_4B9B10, v97 / 8, v92 / 8);
            if ((_BYTE)v93 || (_BYTE)v95)
            {
                if (v105 <= 0)
                    v26 = (v105 >= 0) - 1;
    ...
    if (!v109 && !v90 && v105 && v100)
    {
        ...
        while (++v94 <= 100)
        {
            v103 = 100 * sub_446497(unk_4B9B10, v97, v84);
            v51 = sub_4464F6(unk_4B9B10, v97 / 8, v84 / 8);
            v91 = *(_DWORD*)(thisx + 336) + v103 - v102;
            ...
            else
            {
                v109 = 1;
                LOBYTE(v110) = v51;
                LOWORD(v106) = sub_4744A9(unk_4B9B10, v97 / 8, v84 / 8);
                if ((_BYTE)v93 || (_BYTE)v95)
                {
                    if (v105 <= 0)
                        v23 = (v105 >= 0) - 1;
    ...
    *(_BYTE*)(thisx + 609) = sub_4464F6(unk_4B9B10, *(_DWORD*)(thisx + 328) / 800, *(_DWORD*)(thisx + 332) / 800);
        ...
        case 0x98:
            *(_DWORD*)(thisx + 336) = -v103;
            ...
            else
            {
                ...
                *(_DWORD*)(thisx + 360) = 30;
                sub_43FFC3((int*)unk_4BDB28, unk_4B9A2C, -1, 100, 100, 0);
            }
            break;
        default:
        ...
        || *(_DWORD*)(thisx + 392))
    {
        if (!*(_DWORD*)(thisx + 392))
        {
            v111 = (Concurrency::details::_UnrealizedChore*)sub_4741F8(
                ...
                *(_DWORD*)(thisx + 328) / 800,
                *(_DWORD*)(thisx + 332) / 800);
            v46 = sub_4464F6(unk_4B9B10, *(_DWORD*)(thisx + 328) / 800, *(_DWORD*)(thisx + 332) / 800);
            *(_DWORD*)(thisx + 336) = -v103;
            LOBYTE(v45) = 50;
            if (v111)
...
LABEL_654:
        ...
        && *(int*)(thisx + 348) > 0)
    {
        if (*(_DWORD*)(thisx + 392))
        {
            ...
            {
                v42 = sub_465B44(unk_4B9B10, (Concurrency::details::SchedulerBase*)thisx);
                if (v42)
                {
    ...
    if (v111)
    {
        ...
        *(_DWORD*)(thisx + 208) = v12 - (-*(_DWORD*)(thisx + 336) - v103) / 100;
        ...
        {
            sub_43FFC3((int*)unk_4BDB28, unk_4B9AE4, -1, 100, 100, 0);
            sub_442863(v37);
            sub_4641FE(unk_4B9B10, *(_DWORD*)(thisx + 328), *(_DWORD*)(thisx + 332), -v103, (int)v41);
