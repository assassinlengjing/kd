...
int sub_457F11(int thisx)
{
                ...
                else
                {
                    ...
                    if (*(int*)(thisx + 2528) >= 10 || *(int*)(thisx + 2532) >= 6)
                    {
                        ...
                        else
                        {
                            ...
                            v27 = 0;
                            if (!lstrcmpiA(&String1, &unk_4B2658) && (unsigned __int8)v31 > 1u)
                            {
                                LOBYTE(v31) = v31 - 2;
                                String1 = v30[(unsigned __int8)v31];
                                v26 = v30[(unsigned __int8)v31 + 1];
                            ...
                            if (v28)
                            {
                                for (k = 0; k < 81 && (unk_4B4530[3 * k] != String1 || unk_4B4531[3 * k] != v26); ++k)
                                    ;
                                if (k < 81)
                                {
                                    memcpy(&v30[(unsigned __int8)v31], &unk_4B443C[3 * k], 2u);
                            ...
                            {
                                for (m = 0; m < 10 && (unk_4B4644[3 * m] != String1 || unk_4B4645[3 * m] != v26); ++m)
                                    ;
                                if (m < 10)
                                {
                                    memcpy(&v30[(unsigned __int8)v31], &unk_4B4624[3 * m], 2u);
                                    if ((unsigned __int8)v31 / 2 == *(_WORD*)(thisx + 2570))
                                        ++* (_WORD*)(thisx + 2570);
                                    if (*(_WORD*)(thisx + 2570) == 5)
                                        *(_WORD*)(thisx + 2570) = 4;
                    ...
                    else
                    {
                        memcpy(
                            ...
                            &unk_4B0710[180 * *(unsigned __int16*)(thisx + 2564)
    ...
    for (n = 0; n < 5; ++n)
    {
        if ((_BYTE)v45 || (unsigned __int8)v43 != n || ((unsigned int)unk_4B93B0 >> 1) % 2)
            sub_47B91A(8 * n + 72, 22, &unk_4B2664, 0, -1);
    }
    if ((_BYTE)v45 && (unsigned __int8)v45 < 4u)
    {
        ...
        for (n = 0; n < 2; ++n)
        {
            if ((unsigned __int8)v45 != 1 || *(_DWORD*)(thisx + 2528) != n || ((unsigned int)unk_4B93B0 >> 1) % 4)
            {
                                        ...
                                        if (v18 > 822)
                                        {
                                            if (v18 > 922)
                                            {
                                                if (v18 > 1023)
                                                {
                                                    ...
                                                    {
                                                        if (v18 > 1221)
                                                            wsprintfA(String, &unk_4B26FC);
                                                        else
                                                            wsprintfA(String, &unk_4B26F0);
                                                    }
                                                    else
                                                    {
                                                        wsprintfA(String, &unk_4B26E4);
                                                    }
                                                }
                                                else
                                                {
                                                    wsprintfA(String, &unk_4B26D8);
                                                }
                                            }
                                            else
                                            {
                                                wsprintfA(String, &unk_4B26CC);
                                            }
                                        }
                                        else
                                        {
                                            wsprintfA(String, &unk_4B26C0);
                                        }
                                    }
                                    else
                                    {
                                        wsprintfA(String, &unk_4B26B4);
                                    }
                                }
                                else
                                {
                                    wsprintfA(String, &unk_4B26A8);
                                }
                            }
                            else
                            {
                                wsprintfA(String, &unk_4B269C);
                            }
                        }
                        else
                        {
                            wsprintfA(String, &unk_4B2690);
                        }
                    }
                    else
                    {
                        wsprintfA(String, &unk_4B2684);
                    }
                }
                else
                {
                    wsprintfA(String, &unk_4B2678);
                }
            }
            else
            {
                wsprintfA(String, &unk_4B266C);
            }
    ...
    if ((unsigned __int8)v45 > 1u
        ...
        && ((unsigned __int8)v45 != 2 || ((unsigned int)unk_4B93B0 >> 1) % 4))
    {
