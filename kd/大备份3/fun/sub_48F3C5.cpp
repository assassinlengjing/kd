...
int sub_48F3C5(unsigned __int8* thisx)
{
    ...
    v5 = 8 * thisx[4] + 16;
    v4 = 8 * thisx[5] + 16;
    sub_47B91A(v5, v4, (LPCSTR)unk_4ABBFE, 0, unk_4B9248);
    wsprintfA(String, "%d", (unsigned __int8)unk_4B9990);
    sub_47B7ED(v5 + 16, v4 + 24, String, 0, unk_4B9248);
    result = (_DWORD)sub_48F610((char*)unk_4B9B10);
    v7 = result;
    for (i = 0; i < (unsigned __int8)unk_4B9990; ++i)
    {
        wsprintfA(String, "%d", *(unsigned __int8*)(i + v7));
        sub_47B7ED(v5 + 20 * i + 48, v4 + 24, String, 0, unk_4B9248);
        if (i < (unsigned __int8)unk_4B9990 - 1)
            sub_47B91A(v5 + 20 * i + 58, v4 + 24, aVs_0, 0, unk_4B9248);
        result = i + 1;
    }
    return result;
}
