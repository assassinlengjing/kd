...
int sub_46259F(_BYTE* thisx)
{
    ...
    for (i = 0; i < unk_4B9368; ++i)
    {
        for (j = 0; j < (int)unk_4B93A0; ++j)
            *(_DWORD*)(*((_DWORD*)unk_4B9360 + i) + 4 * j) = 0;
    }
    for (k = 0; k < 2; ++k)
    {
        ...
        *(_DWORD*)(*((_DWORD*)unk_4B9360 + v4) + 4 * (unsigned __int8)sub_426550(&thisx[76 * k + 11816])) = 1;
    }
    sub_4680EF();
    return 1;
}
