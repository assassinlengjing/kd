...
int sub_48ECDE(int thisx)
{
    ...
    v13 = 8 * v13 + 16;
    v11 = 8 * v10 + 16;
    v14 = 224 / (unsigned __int8)unk_4B9990;
    for (i = 0; i < (unsigned __int8)unk_4B9990; ++i)
    {
        wsprintfA(String, "%d", *(unsigned __int8*)(i + thisx + 44));
        sub_47B7ED(v14 / 2 + v13 + v14 * i - 4, v11, String, 0, unk_4B9248);
        if (i < (unsigned __int8)unk_4B9990 - 1)
            sub_47B91A(v14 + v13 + v14 * i - 4, v11, (LPCSTR)aVs, 0, unk_4B9248);
    }
    v7 = v14 / 24;
    if (!(v14 / 24))
        v7 = 1;
    for (j = 0; ; ++j)
    {
        ...
        if (j >= (unsigned __int8)unk_4B9986)
            break;
        v5 = *(_BYTE*)(j + thisx + 36);
        v6 = 0;
        for (k = 0; k < j; ++k)
        ...
        sub_47B7ED(v4 + 4, v11 + 8 * (v6 / v7) + 16, String, 0, unk_4B9248);
