...
_DWORD *__cdecl __sbh_free_block(_DWORD *a1, unsigned int a2)
{
  ...
  *(int *)((char *)v3 + v5 - 4) = v5;
  ...
  if ( v9 )
  {
    if ( !unk_4CC6B0 )
      goto LABEL_46;
    VirtualFree((LPVOID)(*((_DWORD *)unk_4CC6B0 + 3) + (unk_4CC6A8 << 15)), 0x8000u, 0x4000u);
    *((_DWORD *)unk_4CC6B0 + 2) |= 0x80000000 >> unk_4CC6A8;
    *(_DWORD *)(*((_DWORD *)unk_4CC6B0 + 4) + 4 * unk_4CC6A8 + 196) = 0;
    --*(_BYTE *)(*((_DWORD *)unk_4CC6B0 + 4) + 67);
    v22 = (LPVOID *)unk_4CC6B0;
    if ( !*(_BYTE *)(*((_DWORD *)unk_4CC6B0 + 4) + 67) )
    {
      *((_DWORD *)unk_4CC6B0 + 1) &= ~1u;
      v22 = (LPVOID *)unk_4CC6B0;
    }
    if ( v22[2] == (LPVOID)-1 )
    {
      VirtualFree(v22[3], 0, 0x8000u);
      HeapFree((HANDLE)hHeap, 0, *((LPVOID *)unk_4CC6B0 + 4));
      memcpy_0((void*)unk_4CC6B0, (char *)unk_4CC6B0 + 20, (size_t)lpMem + 20 * unk_4CC6B4 - (_DWORD)unk_4CC6B0 - 20);
      result = a1;
      --unk_4CC6B4;
      if ( (int)a1 > unk_4CC6B0 )
        result = a1 - 5;
      unk_4CC6AC = (int)lpMem;
    }
    else
    {
LABEL_46:
