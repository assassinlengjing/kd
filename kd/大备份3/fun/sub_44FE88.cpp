...
int sub_44FE88(int thisx, LPCSTR lpFileName)
{
    ...
    wsprintfA(String, "ShowFPS = %d", unk_4B99F4);
    v7 = lstrlenA(String) + 1;
    wsprintfA(&String[v7], "PutDamage = %d", unk_4B99F0);
    ...
    memset(String, 0, sizeof(String));
    wsprintfA(String, "FullScreen = %d", (unsigned __int8)unk_4B99E9);
    v33 = lstrlenA(String) + 1;
    wsprintfA(&String[v33], "BackGroundRun = %d", (unsigned __int8)unk_4B99E6);
    v34 = v33 + lstrlenA(&String[v33]) + 1;
    wsprintfA(&String[v34], "VsyncWait = %d", (unsigned __int8)unk_4B99E8);
    v35 = v34 + lstrlenA(&String[v34]) + 1;
    wsprintfA(&String[v35], "Zoom = %d", (unsigned __int8)unk_4B99E7);
    ...
    if (!result)
        result = MessageBoxA(0, &unk_4B0FFC, aError_9, 0);
    for (i = 0; i < 8; ++i)
    {
        ...
        if (!WritePrivateProfileSectionA(AppName, String, lpFileName))
            MessageBoxA(0, &unk_4B1088, aError_10, 0);
