...
__int16 sub_4967E4(int a1, double a2, double st5_0, double a4)
{
            ...
            case 1:
                ...
                *(_DWORD*)(a1 + 104) = 100 * sub_4758F0(v75, 0) + v6;
                ...
                if (v4)
                {
                    ...
                    LOWORD(v4) = *(_WORD*)&unk_4B7180[4 * (unsigned __int8)sub_425B70(v75) + v7];
                    *(_WORD*)(a1 + 20) = v4;
                }
                break;
            case 2:
 ...
 /*                               __asm
            ...
            case 5:
                ...
                *(_DWORD*)(a1 + 172) = 1;
                ++* (_DWORD*)(a1 + 156);
                *(_WORD*)(a1 + 20) = unk_4B719C[11 * *(unsigned __int8*)(a1 + 72)];
                if (*(_DWORD*)(a1 + 56)
                    ...
                    else
                    {
                        if (!*(_DWORD*)(a1 + 156))
                        {
                            ...
                            *(_DWORD*)(a1 + 168) = 1;
                            ...
                            if (*(_BYTE*)(a1 + 72) == 11)
                            {
                                sub_43FFC3((_DWORD*)unk_4BDB28, unk_4B9AC4, -1, 100, 100, 0);
                            }
                            else if (*(_BYTE*)(a1 + 72) == 13)
                            {
                                sub_43FFC3((_DWORD*)unk_4BDB28, unk_4B9A34, -1, 100, 100, 0);
                            }
                        }
                        *(_DWORD*)(a1 + 84) = -1;
                        if (*(int*)(a1 + 156) >= 8)
        ...
        else
        {
            ...
            *(_BYTE*)(a1 + 68) = 0;
            *(_BYTE*)(a1 + 71) = 0;
            LOWORD(v4) = unk_4B719C[11 * *(unsigned __int8*)(a1 + 72)];
            *(_WORD*)(a1 + 20) = v4;
            *(_DWORD*)(a1 + 172) = 0;
