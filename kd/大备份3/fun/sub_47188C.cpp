    ...
    if (!*(_BYTE*)(thisx + 2516))
    {
        ...
        if (*(_BYTE*)(thisx + 2562))
        {
            ...
            else if (!(*(_DWORD*)(thisx + 2540) % 60))
            {
                ...
                {
                case 1:
                    wsprintfA(String, &unk_4B38E4);
                    v11 = 100;
                    break;
                case 2:
                    wsprintfA(String, &unk_4B38F4);
                    v11 = 200;
                    break;
                case 3:
                    wsprintfA(String, &unk_4B3914);
                    v11 = -100;
                    break;
                case 4:
                    wsprintfA(String, &unk_4B392C);
                    v11 = 50;
                    break;
                case 5:
                    wsprintfA(String, &unk_4B3944);
                    v11 = 100;
                    break;
                default:
                    break;
                ...
                if (*v14)
                {
                    if (*v14 == 1 && v10)
                    {
                        ...
                        sub_47B91A(168, v8, (LPCSTR)(v10 + 172), 0, unk_4B9248);
                        v5 = unk_4B9248;
                        v3 = unknown_libname_18((char*)(36 * *v7 + unk_4B92E0));
                    ...
                    else if (*v14 == 2 && v10)
                    {
                        ...
                        sub_47B7ED(248, v9, String, 0, unk_4B9248);
                        sub_47B91A(280, v9, &unk_4B3964, 0, unk_4B9248);
                        *(_DWORD*)(v10 + 168) += v11;
                    }
                }
                else
                {
                    sub_47B91A(32, v8, String, 0, unk_4B9248);
                }
        ...
        if (!*(_DWORD*)(thisx + 2540))
        {
            if (*(_BYTE*)(thisx + 2562))
            {
                if (*(_BYTE*)(thisx + 2562) == 6)
                    sub_47F9D6(thisx + 736, &unk_4B39D8, 4);
            }
            else
            {
                sub_47F9D6(thisx + 736, &unk_4B3968, 4);
            }
        }
        ++* (_DWORD*)(thisx + 2540);
    }
