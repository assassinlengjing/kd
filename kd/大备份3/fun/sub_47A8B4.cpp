...
int __cdecl sub_47A8B4(HANDLE hFile)
{
    ...
    ReadFile(hFile, &unk_4B92EC, 2u, (LPDWORD)&NumberOfBytesRead, 0);
    v6 = (unsigned __int16)unk_4B92EC;
    Block = (_DWORD*)operator new(140 * (unsigned __int16)unk_4B92EC + 4);
    v9 = 0;
    if (Block)
    {
        *Block = v6;
    ...
    for (i = 0; i < (unsigned __int16)unk_4B92EC; ++i)
        sub_4909F7((unsigned char*)(unk_4B92E8 + 140 * i), hFile, (unsigned __int8)v5);
    return 1;
}
