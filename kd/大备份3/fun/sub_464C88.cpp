    ...
    *(_DWORD*)(thisx + 2528) = -1;
    ...
    for (i = 0; i < v15; ++i)
    {
        ...
        for (j = 0; j < *(unsigned __int8*)(thisx + v13 + 13002); ++j)
        {
            ...
            sub_47B7ED(v8, v7, String, 0, unk_4B9248);
            sub_47B91A(144 * i + 40, v7, (LPCSTR)&unk_4B2884, 0, unk_4B9248);
            if (*(_BYTE*)(thisx + v13 + 13002) == 2)
                wsprintfA(String, "+%d POINT", 4 - 2 * v9);
            else
                wsprintfA(String, "+%d POINT", 4 - v9);
            sub_47B7ED(144 * i + 56, v14 * j + 68, String, 0, unk_4B9248);
            ...
            if (v11)
            {
                ...
                {
                    v5 = unk_4B9248;
                    v2 = (const CHAR*)unknown_libname_18((char*)(36 * (unsigned __int8)(*(_WORD*)(thisx + 4 * v11 + 11724 + 2 * k) - 2) + unk_4B92E0));
                    sub_47B91A(v8 + 48 * k + 24, v7, v2, 0, v5);
                }
                sub_47B91A(144 * i + 96, v7, (LPCSTR)&unk_4B2654, 0, unk_4B9248);
            }
            else
            {
    ...
    sub_47B91A(16, 208, (LPCSTR)&unk_4B2973, 0, unk_4B9248);
    return sub_47B91A(16, 224, (LPCSTR)&unk_4B309C, 0, unk_4B9248);
}
