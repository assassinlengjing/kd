    ...
    if (!*(_BYTE*)(thisx + 2516))
    {
            ...
            if (*(_BYTE*)(thisx + 2562) || !*(_WORD*)(thisx + 2 * *(_DWORD*)(thisx + 2528) + 2564))
            {
                ...
                case 1:
                    ...
                    *(_DWORD*)(thisx + 2532) = 0;
                    ...
                    sub_47B91A(16, 208, &unk_4B2F38, 0, unk_4B9248);
                    sub_47B91A(16, 224, &unk_4B2F64, 0, unk_4B9248);
                    break;
                case 2:
                    if (*(_DWORD*)(thisx + 2532))
                    {
                        sub_451EB5((_BYTE*)thisx, 0, 1);
                        sub_47B91A(16, 208, &unk_4B2FA4, 0, unk_4B9248);
                        *(_BYTE*)(thisx + 2562) = 1;
                    }
                    else
                    {
                        ...
                        *(_BYTE*)(thisx + 13124) = *(_BYTE*)(thisx + 2528);
                        sub_461335(thisx);
                        sub_451EB5((_BYTE*)thisx, 0, 1);
                        sub_47B91A(16, 208, &unk_4B2F84, 0, unk_4B9248);
                        *(_BYTE*)(thisx + 2562) = 3;
                    }
                    break;
                case 3:
        ...
        else if (sub_476DC7(0, 1))
        {
            if (*(_BYTE*)(thisx + 2562))
            {
                ...
                {
                    sub_451EB5((_BYTE*)thisx, 0, 1);
                    sub_47B91A(16, 208, &unk_4B2FD0, 0, unk_4B9248);
                    *(_BYTE*)(thisx + 2562) = 1;
                }
            }
            else
