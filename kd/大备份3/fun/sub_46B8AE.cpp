...
void sub_46B8AE(_BYTE* thisx, int a2)
{
    ...
    if (a2 == -1)
    {
        ...
        for (i = 0; i < 31; ++i)
        {
            ...
            for (j = 0; j < 9; ++j)
            {
                sub_49CC5B((short*)unk_4BDC60, unk_4B9248, &v110);
                v111 += 40;
            }
        }
        for (k = 0; k < 4; ++k)
    ...
    else
    {
        ...
        if (v100)
        {
            ...
            case 4:
                ...
                if (v94 >= 0 || v96 == 7)
                {
                    ...
                    if (v96 >= 6)
                    {
                        if (v96 == 6)
                        {
                            v39 = (char*)(84 * v94 + unk_4B92D4);
                            v103 = v106 + 4;
                            v104 = v93 + 8;
                            v102 = unk_4B91E0 + 1;
                            SetRect(&rc, 0, 0, 16, 24);
                            sub_4A03B3((short*)unk_4BDC60, unk_4B9248, &v102, (_DWORD*)&rc);
                            v103 = v106 - 4;
                            v104 = v93;
                            v102 = unk_4B91E0;
                            ...
                            sub_47B91A(v106 + 56, yTop + 28, &unk_4B35C0, 0, unk_4B9248);
                            v106 = xLeft + 32;
                            v93 = yTop + 44;
                            for (m = 0; m < 5; ++m)
                            {
                        ...
                        {
                            v106 = xLeft + 8;
                            sub_47B91A(xLeft + 8, yTop + 32, &unk_4B35D0, 0, unk_4B9248);
                            sub_47B91A(v106, yTop + 48, asc_4B35F0, 0, unk_4B9248);
                            sub_47B91A(v106, yTop + 64, asc_4B3608, 0, unk_4B9248);
                            v93 = yTop + 80;
                            sub_47B91A(v106 + 16, yTop + 84, &thisx[244 * a2 + 1564], 0, unk_4B9248);
                        }
                    }
                    else
                    {
                        v103 = v106 + 4;
                        v104 = v93;
                        sub_47900E(&v102, 1, v94, unk_4B9248);
                        v103 = v106;
                        v104 = v93 + 8;
                        v88 = a2;
                        v89 = (unsigned __int8)sub_401710((_BYTE*)(36 * v94 + unk_4B92E0));
                        v87 = (unsigned short*)unk_4B9290;
                        sub_4A1307((int)unk_4B9290, (Concurrency::details::HardwareAffinity*)(8 * a2 + 4952656));
                        sub_485E5A((int)unk_4B93A4 + 24 * v89, (unsigned short*)unk_4B9290);
                        ...
                        v102 = unk_4B9234;
                        sub_4A03B3((short*)unk_4BDC60, unk_4B9248, &v102, (_DWORD*)&rc);
                        if (!thisx[81] && *((_BYTE*)unk_4B92DC + v94))
                        {
                            v103 = v106;
                            v104 = v93 + 4;
                            v102 = unk_4B91E0 + 1;
                        ...
                        v106 = xLeft + 8;
                        v93 = yTop + 28;
                        v90 = (char*)(36 * v94 + unk_4B92E0);
                        v16 = unk_4B9248;
                        v7 = unknown_libname_18(v90);
                        sub_47B91A(v106, yTop + 28, v7, 0, v16);
                        v106 += 56;
                        sub_47B91A(v106, yTop + 28, (LPCSTR)&unk_4B4664[18 * v92], 0, unk_4B9248);
                        if (thisx[a2 + 2596])
                        {
                            for (n = 0; n < 3; ++n)
                            {
                                ...
                                if (v41 >= 73)
                                {
                                    v41 -= 128;
                                    if (v41 >= 13)
                                        sub_47B91A(xLeft + 32, yTop + 16 * n + 44, &unk_4B35B4, 0, unk_4B9248);
                                    else
                                        sub_47B91A(xLeft + 32, yTop + 16 * n + 44, (LPCSTR)&unk_4B4E74[21 * v41], 0, unk_4B9248);
                                }
                                else
                                {
                                    sub_47B91A(xLeft + 32, yTop + 16 * n + 44, (LPCSTR)&unk_4B46C0[27 * v41], 0, unk_4B9248);
                                }
                            }
                            if (thisx[a2 + 13092])
                            {
                                v40 = (unsigned __int8)sub_4266B0(v90, (unsigned __int8)thisx[a2 + 13092] - 1);
                                sub_47BD8E(xLeft + 32, yTop + 60, v40, unk_4B9248);
                            }
                        }
                        else
                        {
                            *(_DWORD*)v56 = unk_4B3548;
                            v57 = unk_4B354C;
                            v58 = 0;
                            v59 = unk_4B3550;
                            v60 = unk_4B3554;
                            ...
                            for (ii = 0; ii < 10; ++ii)
                            {
                                v44 = ((ii % 2) << 6) + v106;
                                v43 = 14 * (ii / 2) + v93;
                                sub_47B91A(v44, v43, &v56[9 * ii], 0, unk_4B9248);
                                wsprintfA(String, "%3d", *(&v46 + ii));
                                sub_47B7ED(v44 + 32, v43, String, 0, unk_4B9248);
                            }
                        }
                    }
                }
            ...
            case 2:
                ...
                v103 = v106 + 4;
                v104 = yTop + 52;
                sub_47900E(&v102, 1, v33, unk_4B9248);
                v103 = v106;
                v104 = yTop + 60;
                v32 = (unsigned __int8)sub_401710((_BYTE*)(36 * v33 + unk_4B92E0));
                sub_4A1307((int)unk_4B9290, (Concurrency::details::HardwareAffinity*)(8 * a2 + 4952656));
                sub_485E5A((int)unk_4B93A4 + 24 * v32, (unsigned short*)unk_4B9290);
                ...
                v106 = xLeft + 8;
                v34 = yTop + 28;
                sub_47B91A(xLeft + 8, yTop + 28, &unk_4B362C, 0, unk_4B9248);
                wsprintfA(v35, "%2d/%2d", *(unsigned __int16*)&thisx[2 * a2 + 2564] + 1, unk_4B99E4);
                sub_47B7ED(v106 + 48, v34 + 16, v35, 0, unk_4B9248);
                if (sub_46D56B((__int16*)thisx + 696, *(unsigned __int16*)&thisx[2 * a2 + 2564], a2))
                {
                    sub_47B91A(v106 + 32, v34 + 32, &unk_4B3654, 0, unk_4B9248);
                    sub_47B91A(v106 + 32, v34 + 48, &unk_4B366C, 0, unk_4B9248);
                }
                break;
            case 3:
                v106 = xLeft + 36;
                sub_47B91A(xLeft + 36, yTop + 52, &unk_4B3680, 0, unk_4B9248);
                sub_47B91A(v106, yTop + 68, &unk_4B3698, 0, unk_4B9248);
                break;
            }
        }
        else
        {
            sub_47B91A(xLeft + 24, yTop + 44, &unk_4B351C, 0, unk_4B9248);
            sub_47B91A(xLeft + 72, yTop + 60, &unk_4B3538, 0, unk_4B9248);
            sub_47B91A(xLeft + 72, yTop + 76, &unk_4B3540, 0, unk_4B9248);
        }
        for (jj = 0; jj < 6; ++jj)
        {
            ...
            if (v28 >= 0 && v28 < (int)Size && v30 >= 0)
            {
                ...
                v103 = v31 + 3;
                v104 = v29 + 1;
                sub_47900E(&v102, 1, v28, unk_4B9248);
                v103 = v31;
                v104 = v29 + 9;
                v27 = (unsigned __int8)sub_401710((_BYTE*)(36 * v28 + unk_4B92E0));
                sub_4A1307((int)unk_4B9290, (Concurrency::details::HardwareAffinity*)(8 * a2 + 4952656));
                sub_485E5A((int)unk_4B93A4 + 24 * v27, (unsigned short*)unk_4B9290);
