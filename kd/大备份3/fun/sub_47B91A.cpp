...
int __cdecl sub_47B91A(int a1, int a2, LPCSTR lpString, int a4, int a5)
{
    ...
    for (i = 0; i < v16; i += 2)
    {
        ...
        else
        {
            ...
            for (j = 0; j < 81; ++j)
            {
                if (String1 == unk_4B443C[3 * j] && v14 == unk_4B443D[3 * j])
                {
                    v10 = 1;
                    String1 = unk_4B4530[3 * j];
                    v14 = unk_4B4531[3 * j];
                    break;
                }
            }
            if (!v10)
            {
                for (k = 0; k < 10; ++k)
                {
                    if (String1 == unk_4B4624[3 * k] && v14 == unk_4B4625[3 * k])
                    {
                        v11 = 1;
                        String1 = unk_4B4644[3 * k];
                        v14 = unk_4B4645[3 * k];
                        break;
                    }
                }
            }
            for (m = 0; m < 246 && (String1 != unk_4B4158[3 * m] || v14 != unk_4B4159[3 * m]); ++m)
                ;
            if (m != 246)
            {
                for (n = 0; n < (a4 & 1) + 1; ++n)
