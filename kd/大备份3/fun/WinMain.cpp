...
int aWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
    ...
    if (!hPrevInstance && !sub_47E539(hInstance))
        return 0;
    for (i = 0; i < 8; ++i)
        sub_47652C((int*)&unk_4B9410[108 * i], i);
    unk_4B99F8 = 1;
    unk_4B99F4 = 0;
    unk_4B99F0 = 1;
    unk_4B99C9 = 0;
    ...
    while (1)
    {
        while (1)
        {
            ...
            if (PeekMessageA(&Msg, 0, 0, 0, 0))
                break;
            if (unk_4B99F8 || unk_4B99E6)
            {
                if (unk_4B91D0 || v15 - Time >= 0x11)
                {
                    if (!unk_4B91D0)
                    {
                        if (unk_4B99EC)
                        ...
                        while (v16 >= 0x11)
                        {
                            sub_443059(unk_4B9B10, v4, v5, v6, 0);
                            v16 -= 17;
                        }
                    }
                    Time = v15;
                    ...
                    sub_443059(unk_4B9B10, v4, v5, v6, 1);
                    if (unk_4B99F4)
                    {
                        wsprintfA(String, "%d", unk_4CA1CC);
