...
int sub_47AA55()
{
    ...
    if (!sub_482C74((int)v3, aGraphicSkincol))
        goto LABEL_11;
    unk_4B93A0 = sub_4831B2(v3, aStart_10, aEnd_6);
    if ((int)unk_4B93A0 <= 0)
        goto LABEL_11;
    v5 = unk_4B93A0;
    Block = (_DWORD*)operator new(24 * unk_4B93A0 + 4);
    LOBYTE(v6) = 1;
    if (Block)
    {
        *Block = v5;
    ...
    LOBYTE(v6) = 0;
    unk_4B93A4 = (_DWORD)v1;
    if (v1 && (Src = (_DWORD)operator new(2 * unk_4B93A0)) != 0 && (unk_4B9394 = (_DWORD)operator new(8 * unk_4B93A0)) != 0)
    {
        sub_48328F(v3, aStart_11);
        sub_482FAA(v3);
        for (i = 0; i < (int)unk_4B93A0; ++i)
        {
            if (!sub_485BCA((int)unk_4B93A4 + 24 * i, v3))
                goto LABEL_11;
        }
        v6 = -1;
        sub_482C2F(v3);
