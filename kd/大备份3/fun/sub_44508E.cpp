...
int sub_44508E(int a1, double a2, double a3, double a4)
{
    ...
    *(_DWORD*)(a1 + 2488) = 100;
    *(_DWORD*)(a1 + 2492) = 0;
    unk_4B9999 = *(_BYTE*)(a1 + 29);
    memset(unk_4B999B, 0, sizeof(unk_4B999B));
    memset(unk_4B99A3, 0, 8u);
    for (i = 0; i < (int)unk_4B93A0; ++i)
        *((_WORD*)unk_4B9394 + i) = -1;
    for (j = 0; j < (int)unk_4B93A0; ++j)
    {
        for (k = 0; k < 4; ++k)
            *((_WORD*)*(&unk_4B9370 + k) + j) = -1;
    }
    for (m = 0; m < unk_4B9368; ++m)
    {
        for (n = 0; n < (int)unk_4B93A0; ++n)
            *(_DWORD*)(*((_DWORD*)unk_4B9360 + m) + 4 * n) = 0;
    }
    for (ii = 0; ii < 8; ++ii)
    ...
    *(_BYTE*)(a1 + 2545) = 0;
    ...
    else if (*(_DWORD*)(a1 + 116) == 3)
    {
        ...
        *(_BYTE*)(a1 + 2547) = 7;
        unk_4B9985 = 8;
        unk_4B9987 = 7;
        for (kk = (unsigned __int8)unk_4B9986; kk < (unsigned __int8)unk_4B9985; ++kk)
        {
            ...
            *(_BYTE*)(kk + a1 + 2588) = 1;
            *(_BYTE*)(kk + a1 + 2580) = MarkedForDetachment((_BYTE*)(36 * mm + unk_4B92E0));
        }
    }
    else if (!*(_DWORD*)(a1 + 116))
    {
        unk_4B99CC = *(_BYTE*)(a1 + 11664);
        unk_4B999A = *(_BYTE*)(a1 + 11614);
        unk_4B99C8 = *(_BYTE*)(a1 + 11660);
        unk_4B99DF = *(_BYTE*)(a1 + 11683);
        unk_4B99E0 = *(_BYTE*)(a1 + 11684);
    }
    if (!unk_4B9999)
        unk_4B9999 = rand() % *(_DWORD*)(a1 + 13388) + 1;
    if (*(_DWORD*)(a1 + 116) || unk_4B9984 != 2)
    {
        if (*(_DWORD*)(a1 + 116) || unk_4B9984 != 3)
        {
            if (*(_DWORD*)(a1 + 116) || unk_4B9984 != 4)
                sub_486189(a1 + 128, (unsigned __int8)unk_4B9999, 0);
            else
                sub_486189(a1 + 128, (unsigned __int8)unk_4B9999, aDoubledragonWa);
        }
        else
        {
            sub_486189(a1 + 128, (unsigned __int8)unk_4B9999, aBoss03Wav);
        }
    }
    else
    {
        sub_486189(a1 + 128, (unsigned __int8)unk_4B9999, aBoss02Wav);
    }
    for (nn = 0; nn < (unsigned __int8)unk_4B9985; ++nn)
    {
        v53 = (unsigned __int8)unk_4B9988[nn];
        ...
        if (!unk_4B9974)
        {
            ...
            {
                if (nn >= (unsigned __int8)unk_4B9986)
                    sub_475050((char*)v54, unk_4B9986);
                else
        ...
        if (!unk_4B9974)
        {
            ...
            if (*(_DWORD*)(a1 + 116) == 4)
            {
                ...
                v50 = a1 + 244 * v8 + 1392;
                v51 = (_BYTE*)(84 * *(__int16*)(a1 + 244 * v8 + 1628) + unk_4B92D4);
        ...
        if (v53 >= (unsigned __int8)unk_4B9986)
        {
        ...
        if (unk_4B9974 || *(_DWORD*)(a1 + 116) == 4)
        {
            if (!unk_4B9974)
                sub_474ED0((short*)v54, unk_4B99CE[nn]);
        }
        else
        {
            sub_417763((short*)v54);
            unk_4B99CE[nn] = sub_474EB0((short*)v54);
        }
    }
    v62 = (unsigned __int8)unk_4B9985;
    memset(v78, 0, sizeof(v78));
    if (*(_DWORD*)(a1 + 116) == 3)
    {
        for (i2 = 0; i2 < (int)Size; ++i2)
        {
            v44 = (_BYTE*)(36 * i2 + unk_4B92E0);
    ...
    {
        for (i3 = 0; i3 < (unsigned __int8)unk_4B9985; ++i3)
        {
            v42 = (_BYTE*)(a1 + 612 * (unsigned __int8)unk_4B9988[i3] + 2628);
    ...
    if (*(_DWORD*)(a1 + 116) == 3)
    {
        memcpy((void*)unk_4B9394, (void*)Src, 2 * unk_4B93A0);
        for (i4 = 0; i4 < 4; ++i4)
            memcpy((void*)*(&unk_4B9370 + i4), (void*)*(&unk_4B9380 + i4), 2 * unk_4B93A0);
        for (i5 = 0; i5 < 4; ++i5)
        {
            if (v78[i5])
            {
                v40 = 0;
                for (i6 = 0; i6 < (int)unk_4B93A0; ++i6)
                {
                    if (*((__int16*)unk_4B9394 + i6) >= 0)
                        *((_WORD*)*(&unk_4B9370 + i5) + i6) = v40++;
                }
            }
        }
    }
    else
    {
        for (i7 = 0; i7 < v62; ++i7)
        {
            v33 = (_BYTE*)(a1 + 612 * (unsigned __int8)unk_4B9988[i7] + 2628);
            v32 = (unsigned __int16)sub_474F50((short*)v33);
            v34 = sub_4264F0(v33);
            if (v34 < 4u)
                *((_WORD*)*(&unk_4B9370 + v34) + v32) = 1;
            *((_WORD*)unk_4B9394 + v32) = 1;
        }
        for (i8 = 0; i8 < 4; ++i8)
        {
            if (v78[i8])
            {
                v37 = 0;
                for (i9 = 0; i9 < (int)unk_4B93A0; ++i9)
                {
                    if (*((__int16*)unk_4B9394 + i9) >= 0)
                        *((_WORD*)*(&unk_4B9370 + i8) + i9) = v37++;
                }
            }
        }
        v38 = 0;
        for (i10 = 0; i10 < (int)unk_4B93A0; ++i10)
        {
            if (*((__int16*)unk_4B9394 + i10) != -1)
                *((_WORD*)unk_4B9394 + i10) = v38++;
        }
    }
    sub_466A41();
    if (*(_DWORD*)(a1 + 116) == 3)
    ...
    for (i12 = 0; i12 < (unsigned __int8)unk_4B9985; ++i12)
    {
        v28 = (unsigned __int8)unk_4B9988[i12];
        v29 = (_BYTE*)(a1 + 612 * v28 + 2628);
        if (*(_DWORD*)(a1 + 116) == 3 && v28 >= (unsigned __int8)unk_4B9986)
        {
            v22 = sub_4264F0(v29);
            sub_474FD0((int*)v29, unk_4B9220[v22]);
        }
        else if (unk_4B9974)
        {
            sub_41C48F((int)v29, -2);
        }
        else if (*(_DWORD*)(a1 + 116) || i12 < 2 || unk_4B9984 != 2)
        {
    ...
    while (i12 < 8)
        Concurrency::details::InternalContextBase::UNSAFE_SetVirtualProcessor(
            (Concurrency::details::InternalContextBase*)(a1 + 612 * (unsigned __int8)unk_4B9988[i12++] + 2628),
            0);
    sub_452E9A(a1);
    if (*(_DWORD*)(a1 + 116) == 3)
    {
        for (i13 = 0; i13 < unk_4B9368; ++i13)
        {
            for (i14 = 0; i14 < (int)unk_4B93A0; ++i14)
            {
                if (*(_BYTE*)(*((_DWORD*)unk_4B9364 + i13) + i14) == 1)
                    *(_DWORD*)(*((_DWORD*)unk_4B9360 + i13) + 4 * i14) = 1;
            }
        }
    }
    sub_4680EF();
    if (*(_DWORD*)(a1 + 116) || unk_4B9974)
    {
        if (*(_DWORD*)(a1 + 116) == 4 && !unk_4B9974)
        {
            memcpy(unk_4B999B, (const void*)(a1 + 2403), sizeof(unk_4B999B));
            memcpy(unk_4B99A3, (const void*)(a1 + 2411), 8u);
        }
    }
    else
    {
        for (i15 = 0; i15 < 2; ++i15)
        {
            ...
            {
                unk_4B999B[i15] = *(_BYTE*)(i15 + a1 + 11808);
                unk_4B99A3[i15] = *(_BYTE*)(i15 + a1 + 11810);
            }
        }
    }
    *(_DWORD*)(a1 + 2508) = 0;
    for (i16 = 0; i16 < (unsigned __int8)unk_4B9985; ++i16)
        *(_DWORD*)(a1 + 2508) += (unsigned __int16)sub_43E520((short*)a1 + 612 * i16 + 2628);
    *(int*)(a1 + 2508) /= (int)(unsigned __int8)unk_4B9985;
