    ...
    for (i = 0; i < 8 && (*(_DWORD*)(thisx + 116) != 3 || i <= 0); ++i)
    {
        ...
        if (unknown_libname_7((_DWORD*)(thisx + 612 * (unsigned __int8)v29 + 2628)))
        {
            ...
            else
            {
                v35 = xLeft;
                v36 = v28;
                v34 = (unsigned __int8)v29 + unk_4B9200;
                sub_49AB05((int)unk_4BDC60, &v34);
                v35 += 8;
                v34 = unk_4B9200 + 8;
            }
            ...
            {
                v34 = unk_4B9204
                    + *((__int16*)unk_4B9394 + (unsigned __int16)sub_43E5A0((short*)thisx + 612 * (unsigned __int8)v29 + 2628))
                    + 1;
            ...
            if (!*(_BYTE*)(thisx + (unsigned __int8)v29 + 13052) && ((unsigned __int8)v27 == 2 || (unsigned __int8)v27 == 3))
            {
                ...
                v35 = v16 + 40;
                v36 = v15;
                v34 = unk_4B91DC + (unsigned __int8)v17 + 3;
                sub_49AB05((int)unk_4BDC60, &v34);
            }
            ...
            if ((_BYTE)v31)
            {
                ...
                if ((unsigned __int8)v31 >= 0x80u)
                    sub_47B91A(xLeft + 16, v28 + 16, (LPCSTR)&unk_4B06C0[13 * (unsigned __int8)v31 - 1664], 0, -1);
                else
                    sub_47B91A(xLeft + 16, v28 + 16, (LPCSTR)&unk_4B0698[13 * (unsigned __int8)v31 - 13], 0, -1);
            }
            ...
            if (*(_BYTE*)(thisx + (unsigned __int8)v29 + 16128))
            {
                ...
                if (*(_DWORD*)(thisx + 2372))
                {
                    ...
                    if ((unsigned __int8)unk_4B9985 <= 4u)
                    {
