...
int sub_46DD55(int a1, double a2, double a3, double a4)
{
    ...
    *(_DWORD*)(a1 + 2528) = 0;
    ...
    for (i = 0; i < 4; ++i)
    {
        *(_BYTE*)(i + a1 + 2616) = unk_4B9988[(*(_DWORD*)(a1 + 2368) + 1) * i] + 1;
        if (*(unsigned __int8*)(i + a1 + 2616) > (int)(unsigned __int8)unk_4B9986)
            *(_BYTE*)(i + a1 + 2616) = 0;
    }
    for (i = 0; i < 4; ++i)
    {
    ...
    for (m = 0; m < 4; ++m)
    {
            ...
            ++i)
        {
            ...
            sub_485E5A((int)unk_4B93A4 + 24 * v6, (unsigned __int16*)(8 * (i + 2 * m) + 4952720));
        }
    }
    sub_46D3E1();
    sub_46F18C(a1, -1);
