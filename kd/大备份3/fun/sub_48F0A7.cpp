...
int sub_48F0A7(_DWORD* thisx)
{
    ...
    if (v17)
    {
        thisx[5] = (v17 + thisx[5] + (unsigned __int8)unk_4B9990 + 1) % ((unsigned __int8)unk_4B9990 + 1);
        v19 = 3;
    ...
    else if (v16)
    {
        ...
        if (thisx[5])
        {
            ...
            if (v9 <= (unsigned __int8)unk_4B9985)
                v14[thisx[5] - 1] = v10;
        }
        else
        {
            v13 = v16 + (unsigned __int8)unk_4B9990;
            if (v13 >= 2)
            {
                if (v13 > (unsigned __int8)unk_4B9985)
                    LOBYTE(v13) = unk_4B9985;
            }
            else
            {
                LOBYTE(v13) = 2;
            ...
            {
                if (j + 1 > (unsigned __int8)unk_4B9985 % (int)(unsigned __int8)unk_4B9990)
                    LOWORD(v3) = (unsigned __int8)unk_4B9985 / (__int16)(unsigned __int8)unk_4B9990;
                else
                    v3 = (unsigned __int8)unk_4B9985 / (int)(unsigned __int8)unk_4B9990 + 1;
                v14[j] = v3;
            }
        }
    }
    else if (v15 || v18)
    {
        ...
        {
            v19 = 0;
            sub_47B91A(16, 224, (LPCSTR)unk_4ABC40, 0, unk_4B9248);
        }
    }
    return v19;
}
