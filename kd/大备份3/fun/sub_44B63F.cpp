...
int  sub_44B63F(int thisx, double a2, double a3, double a4)
{
            ...
            if (*(_DWORD*)(thisx + 116))
            {
                if (*(_DWORD*)(thisx + 116) == 4)
                {
                    ...
                    *(_BYTE*)(thisx + 2516) = 2;
                    ...
                    {
                        v17 = (Concurrency::details::SchedulerBase*)(thisx + 612 * (unsigned __int8)unk_4B9988[i] + 2628);
            ...
            if (*(_DWORD*)(thisx + 116) == 3)
            {
                if (!unk_4B9974)
                {
                    ...
                    if (*(_DWORD*)(thisx + 11376) > *(_DWORD*)(thisx + 4 * result + 11380))
                        return sub_47B91A(140, 224, &unk_4B0B10, 0, -1);
                }
            }
    ...
    if (*(int*)(thisx + 2520) >= 240)
    {
        if ((result = thisx, *(_DWORD*)(thisx + 116)) && *(_DWORD*)(thisx + 116) != 4 || unk_4B9974)
        {
            sub_477F0C(0);
            v5 = sub_476CDA(0);
            v8 = v5 - sub_476C8B(0);
            ...
            if (unk_4B9974)
            {
                sub_47B91A(120, 68, &unk_4B0B24, 0, -1);
                sub_47B91A(120, 84, &unk_4B0B38, 0, -1);
            }
            else
            {
                sub_47B91A(120, 68, &unk_4B0B50, 0, -1);
                sub_47B91A(120, 84, &unk_4B0B60, 0, -1);
                sub_47B91A(120, 100, &unk_4B0B74, 0, -1);
                sub_47B91A(120, 116, &unk_4B0B8C, 0, -1);
            }
