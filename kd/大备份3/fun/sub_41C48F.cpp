...
int sub_41C48F(int thisx, int a2)
{
    ...
    for (j = 0; j < v18; ++j)
    {
        if (!v17 || *((__int16*)unk_4B9394 + j) != -1)
        {
            memcpy(v10, Buffer, sizeof(v10));
            if (v17)
                sub_485DFD((int)unk_4B93A4 + 24 * j, (int)v10);
            else
                sub_485DFD((int)unk_4B93A4 + 24 * *(unsigned __int16*)(thisx + 498), (int)v10);
            v15[1] = 0;
            v15[2] = 0;
            v15[3] = -1;
            v15[4] = -1;
    ...
    *(_DWORD*)(*((_DWORD*)unk_4B9360 + *(unsigned __int8*)(thisx + 192)) + 4 * *(unsigned __int16*)(thisx + 498)) = 1;
    if (*(_BYTE*)(thisx + 195) == 4)
    {
        ...
        {
            v4 = (_BYTE*)(36 * *(unsigned __int16*)(thisx + 186) + unk_4B92E0);
            v6 = sub_4016F0(v4);
            v7 = (unsigned __int8)sub_401710(v4);
        }
        *(_DWORD*)(*((_DWORD*)unk_4B9360 + v6) + 4 * v7) = 1;
    }
    return 1;
}