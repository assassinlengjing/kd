...
int sub_484723(int thisx, LPCSTR lpFileName)
{
    ...
    else
    {
        ...
        else
        {
            ...
            ReadFile(hFile, &unk_4B9980, 4u, (LPDWORD)&NumberOfBytesRead, 0);
            ReadFile(hFile, &unk_4B9985, 1u, (LPDWORD)&NumberOfBytesRead, 0);
            ReadFile(hFile, &unk_4B9986, 1u, (LPDWORD)&NumberOfBytesRead, 0);
            LOBYTE(v16) = unk_4B9986;
            ReadFile(hFile, unk_4B9988, (unsigned __int8)unk_4B9986, (LPDWORD)&NumberOfBytesRead, 0);
            ReadFile(hFile, &unk_4B9990, 1u, (LPDWORD)&NumberOfBytesRead, 0);
            ReadFile(hFile, (LPVOID)(thisx + 2220), 1u, (LPDWORD)&NumberOfBytesRead, 0);
            if ((unsigned __int8)v20 < 2u)
                unk_4B9984 = 0;
            else
                ReadFile(hFile, &unk_4B9984, 1u, (LPDWORD)&NumberOfBytesRead, 0);
            ReadFile(hFile, &unk_4B9998, 1u, (LPDWORD)&NumberOfBytesRead, 0);
            ReadFile(hFile, &unk_4B9999, 1u, (LPDWORD)&NumberOfBytesRead, 0);
            ReadFile(hFile, &unk_4B999A, 1u, (LPDWORD)&NumberOfBytesRead, 0);
            ReadFile(hFile, unk_4B999B, 8u, (LPDWORD)&NumberOfBytesRead, 0);
            ReadFile(hFile, unk_4B99A3, 8u, (LPDWORD)&NumberOfBytesRead, 0);
            ...
            ReadFile(hFile, &unk_4B99C8, 1u, (LPDWORD)&NumberOfBytesRead, 0);
            ReadFile(hFile, &unk_4B99C9, 1u, (LPDWORD)&NumberOfBytesRead, 0);
            ReadFile(hFile, &unk_4B99CA, 1u, (LPDWORD)&NumberOfBytesRead, 0);
            ReadFile(hFile, &unk_4B99CB, 1u, (LPDWORD)&NumberOfBytesRead, 0);
            ReadFile(hFile, &unk_4B99CC, 1u, (LPDWORD)&NumberOfBytesRead, 0);
            ReadFile(hFile, &unk_4B99CD, 1u, (LPDWORD)&NumberOfBytesRead, 0);
            if ((_BYTE)v20)
            {
