...
int sub_402C05(int thisx)
{
    ...
    *(_DWORD*)(thisx + 344) = 0;
    ...
    if (*(_BYTE*)(thisx + 178))
    {
        ...
        else
        {
            ...
            {
                sub_476009(&unk_4B9410[108 * *(unsigned __int8*)(thisx + 184)]);
                v2 = sub_476A79((int*)&unk_4B9410[108 * *(unsigned __int8*)(thisx + 184)]);
                v61 = v2 - sub_476A64((int*)&unk_4B9410[108 * *(unsigned __int8*)(thisx + 184)]);
                v3 = sub_476A4F((int*)&unk_4B9410[108 * *(unsigned __int8*)(thisx + 184)]);
                v58 = v3 - sub_476A3A((int*)&unk_4B9410[108 * *(unsigned __int8*)(thisx + 184)]);
            }
            for (j = 0; j < 6; ++j)
            {
                v45 = 0;
                ...
                {
                    v45 = sub_476485((int*)&unk_4B9410[108 * *(unsigned __int8*)(thisx + 184)], j);
                }
                if (v45)
                {
    ...
    if (unk_4B99C8 && v65 && (v59 || v55 || v53) && !*(_BYTE*)(thisx + 556))
    {
        if (v59)
        {
            *(_BYTE*)(thisx + 556) = 1;
        ...
        if (v59 && v48)
            *(_BYTE*)(thisx + 234) = 5;
        *(_BYTE*)(thisx + 557) = 60;
        sub_43FFC3((int*)unk_4BDB28, unk_4B9AB4, -1, 100, 100, 0);
    ...
    if ((unk_4B99CA && *(int*)(thisx + 444) > 18 || !unk_4B99CA)
        && !v53
        && *(_DWORD*)(thisx + 428) == 77
        && !*(_DWORD*)(thisx + 340))
    {
    ...
    v68 = 0;
    if (v59)
        v68 = sub_446D6F(unk_4B9B10, (Concurrency::details::SchedulerBase*)thisx);
    ...
    *(_DWORD*)(thisx + 308) = 0;
    if (!*(_DWORD*)(thisx + 480)
        ...
        && !*(_DWORD*)(thisx + 288))
    {
        *(_DWORD*)(thisx + 308) = sub_457731(unk_4B9B10, (_DWORD*)thisx);
    }
    ...
    if (!*(_BYTE*)(thisx + 188) && v48 && *(_DWORD*)(thisx + 428) == 10)
        v51 = (int*)sub_446814(unk_4B9B10, (_DWORD*)thisx);
    v60 = 83;
    v63 = 0;
    if (*(_DWORD*)(thisx + 164))
        v63 = *(_DWORD*)(thisx + 16);
    ...
    if (*(_BYTE*)(thisx + 188) != 1 && unk_4B99CA && (v59 || v55) && v50 && sub_463F66((char*)unk_4B9B10, (_BYTE*)thisx))
    {
        *(_DWORD*)(thisx + 432) = 77;
        *(_BYTE*)(thisx + 221) = 0;
        *(_DWORD*)(thisx + 444) = 0;
    ...
    if (v52)
    {
        ...
        {
            sub_43FFC3((int*)unk_4BDB28, unk_4B9A74, -1, 100, 100, 0);
            *(_DWORD*)(thisx + 432) = 28;
        }
    ...
    if (v59 && *(_DWORD*)(thisx + 404))
    {
        ...
        if (!*(_BYTE*)(thisx + 188) && !v68)
            v39 = (int*)sub_446814(unk_4B9B10, (_DWORD*)thisx);
        if (!*(_BYTE*)(thisx + 188) && !v68 && !v39)
            v38 = (int*)sub_446A62(unk_4B9B10, (_DWORD*)thisx, 0);
            ...
            if (*(_DWORD*)(thisx + 428) != 53 && *(_DWORD*)(thisx + 428) != 56)
            {
                ...
                else if (*(_DWORD*)(thisx + 288))
                {
                    if (*(_DWORD*)(thisx + 392))
                        ...
                        *(_DWORD*)(thisx + 432) = 65;
                    if (*(_DWORD*)(thisx + 304)
                        || (*(_DWORD*)(thisx + 304) = sub_465804(unk_4B9B10, (int*)thisx)) != 0
                    ...
                    if ((v61 || v58) && *(_DWORD*)(thisx + 396) && !*(_DWORD*)(thisx + 292))
                    {
                        ...
                        *(_DWORD*)(thisx + 356) = 0;
                            ...
                            && !*(_DWORD*)(thisx + 480))
                        {
                            ...
                            if (v28 >= 0)
                            {
                                *(_DWORD*)(thisx + 304) = sub_446714(unk_4B9B10, v28);
    ...
    if (!*(_BYTE*)(thisx + 188) && !v68)
    {
        if (sub_41BA53(thisx, 0x30u, 0))
            v37 = (int*)sub_446A62(unk_4B9B10, (_DWORD*)thisx, 1);
        if (!v37)
            v36 = (int*)sub_446A62(unk_4B9B10, (_DWORD*)thisx, 0);
    }
