...
int sub_456D33(const CHAR* thisx, LPCSTR lpString2, int a3, int a4)
{
    ...
    if (sub_475810((_DWORD*)dword_4BDB28) && !a4 && (!lpString2 || !lstrcmpiA(thisx + 13125, lpString2)))
        return 1;
    sub_440C04((_DWORD*)dword_4BDB28, 0);
    ...
    if (sub_482C74((int)v8, String))
    {
        while (sub_482D44(v8, String1))
        {
            if (!lstrcmpiA(String1, aLooppos))
            {
                ...
                v5 = atol(String1);
                sub_440C04((_DWORD*)dword_4BDB28, v5);
            }
        }
    }
    String[v9 - 3] = 119;
    String[v9 - 2] = 97;
    String[v9 - 1] = 118;
    if (sub_4404CB((_DWORD*)dword_4BDB28, String, a3))
    {
