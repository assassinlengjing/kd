...
void __fastcall sub_40230C(int a1)
{
    ...
    if (*(_DWORD*)(a1 + 428) != 80)
    {
        ...
        v26 = v23[0];
        v24 = v23[1];
        v36 = (_BYTE*)sub_4741F8((int)byte_4B9B10, v22 / 800, *(_DWORD*)(a1 + 332) / 800);
        v32 = sub_446497((int*)byte_4B9B10, v22 / 100, *(_DWORD*)(a1 + 332) / 100);
        ...
        v35 = sub_4464F6((int*)byte_4B9B10, v22 / 800, *(_DWORD*)(a1 + 332) / 800);
        sub_49C15E((int)&Src);
        if ((_BYTE)v28 && (*(_DWORD*)(a1 + 392) || v29))
        {
            v38 = v26 - 8;
            v1 = *(_DWORD*)(a1 + 332) / 100 - v32;
            v39 = v1 + sub_4464BA((int)byte_4B9B10) - 2;
            if (v36)
                v39 -= v30;
            Src = dword_4B9214;
        ...
        if (!*(_BYTE*)(a1 + 176))
        {
            ...
            v39 = v24;
            v40 = *(_DWORD*)(a1 + 424);
            if (Concurrency::details::UMSFreeVirtualProcessorRoot::GetExecutingProxy((Concurrency::details::UMSFreeVirtualProcessorRoot*)byte_4B9B10) == (struct Concurrency::details::UMSThreadProxy*)23)
            {
            ...
            else
            {
                Src = *(unsigned __int8*)(a1 + 195) < 4u
                    && (sub_41BA53(a1, 0x26u, 0) || *(_DWORD*)(a1 + 524) || sub_425CD0((int*)byte_4B9B10) == 3 && *(_BYTE*)(a1 + 184)) ? *((__int16*)*(&dword_4B9370 + *(unsigned __int8*)(a1 + 195)) + *(unsigned __int16*)(a1 + 498)) + *(_DWORD*)(a1 + 196) : *(_DWORD*)(a1 + 196);
            }
            ...
            if (v21)
            {
                ...
                for (i = 0; i < v34 + 1; ++i)
                {
                    ...
                    if (i != v34)
                    {
                        ...
                        sub_48FB00((int)v33, (int)&Src, (int)byte_4BDC60, &Src, yTop);
                    }
                }
                if (dword_4B93A8)
                {
