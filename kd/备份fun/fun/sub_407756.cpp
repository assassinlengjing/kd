        ...
        *(_DWORD*)(a3 + 24) = v24;
        if (v24)
        {
            *(_DWORD*)(thisx + 444) = 8;
            ...
            sub_43FFC3((_DWORD*)dword_4BDB28, dword_4B9A28, -1, 100, 100, 0);
        LABEL_248:
            if (*(_DWORD*)(thisx + 164))
        ...
        LABEL_98:
            ...
            if (!*(_BYTE*)(thisx + 558) && !*(_DWORD*)(thisx + 560))
            {
                ...
                if (*(_DWORD*)(thisx + 428) == 94)
                    sub_464C06((char*)byte_4B9B10, 2, thisx);
            }
            if (*(_DWORD*)(thisx + 432) != 38
                && *(_DWORD*)(thisx + 432) != 17
                && *(_DWORD*)(thisx + 432) != 18
                ...
                else
                {
                    ...
                    if (v21 == -1)
                    {
                        if ((unsigned __int8)v27 == 1)
                            sub_43FFC3((_DWORD*)dword_4BDB28, dword_4B9A10, -1, 100, 100, 0);
                        else
                            sub_43FFC3((_DWORD*)dword_4BDB28, dword_4B9A0C, -1, 100, 100, 0);
                    }
                    else
                    {
                        sub_43FFC3((_DWORD*)dword_4BDB28, dword_4B99FC[v21], -1, 100, 100, 0);
                    }
                }
            }
            goto LABEL_248;
                ...
                if (*(_DWORD*)(thisx + 428) != 147 || *(_DWORD*)(thisx + 436))
                {
                    ...
                    else if (*(_DWORD*)(thisx + 428) != 97 || *(_DWORD*)(a3 + 48) == 83)
                    {
                            ...
                            || !sub_41BA53(thisx, 0x29u, 0))
                        {
                            ...
                            {
                                *(_DWORD*)(thisx + 312) = sub_466127((char*)byte_4B9B10, (_BYTE*)thisx, thisx + 453);
                            }
