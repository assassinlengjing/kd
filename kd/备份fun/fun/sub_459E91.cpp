...
void sub_459E91(int thisx, int a2)
{
    ...
    case 0:
        ...
        sub_4A02E9((_DWORD*)byte_4BDC60, v3, (int)v33, v2, v10);
        ...
        for (i = 0; i < 10; ++i)
        {
            ...
            {
            case 0:
                wsprintfA(v29, &byte_4B2758);
                break;
            case 1:
                wsprintfA(v29, &byte_4B2760);
                break;
            case 2:
                wsprintfA(v29, &byte_4B2768);
                break;
            case 3:
                wsprintfA(v29, &byte_4B2774);
                break;
            case 4:
                wsprintfA(v29, &byte_4B2780);
                break;
            case 5:
                wsprintfA(v29, &byte_4B2788);
                break;
            case 6:
                wsprintfA(v29, &byte_4B2790);
                break;
            case 7:
                wsprintfA(v29, &byte_4B279C);
                break;
            case 8:
                wsprintfA(v29, &byte_4B27A8);
                break;
            case 9:
                wsprintfA(v29, &byte_4B27B4);
                break;
            default:
                break;
            }
    ...
    case 1:
        ...
        sub_4A03B3((short*)byte_4BDC60, dword_4B9248, &v25, (_DWORD*)&rc);
        v26 += 4;
        v27 -= 8;
        if (*(_BYTE*)(thisx + 2562))
        {
