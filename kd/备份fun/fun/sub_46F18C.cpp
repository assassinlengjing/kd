...
void sub_46F18C(int thisx, int a2)
{
    ...
    if (a2 == -1)
    {
        ...
        for (i = 1; i < 31; ++i)
        {
            ...
            for (j = 0; j < 9; ++j)
            {
                sub_49CC5B((short*)byte_4BDC60, dword_4B9248, &v105);
                v106 += 40;
            }
        }
        v100 = 8;
    ...
    else if (a2 >= 0 && a2 < 4)
    {
        ...
        sub_4A02E9((_DWORD*)byte_4BDC60, v2, (int)&v91, 0, dword_4B9248);
        v98 = 160 * (a2 / 2) + 115;
        v89 = yTop;
        for (m = *(_DWORD*)(thisx + 2368) == 0; m < 2; ++m)
        {
            ...
            sub_4A02E9((_DWORD*)byte_4BDC60, v4, (int)&v91, v3, v17);
        }
        v98 = xLeft;
        SetRect(&v91, xLeft, yTop + 24, xLeft + 152, yTop + 104);
        sub_4A02E9((_DWORD*)byte_4BDC60, v5, (int)&v91, 0, dword_4B9248);
        v98 = xLeft + 3;
        SetRect(&v91, xLeft + 3, yTop + 56, xLeft + 28, yTop + 100);
        v18 = dword_4B9248;
        v6 = sub_49FFEC(198, 113, 0);
        sub_4A02E9((_DWORD*)byte_4BDC60, v7, (int)&v91, v6, v18);
        ...
        for (m = 0; m < v83; ++m)
        {
            ...
            if (v88 >= 6)
            {
                if (v88 == 6)
                {
                    ...
                    sub_4A03B3((short*)byte_4BDC60, dword_4B9248, &v93, (_DWORD*)&v91);
                    v96 = 0;
                }
            }
            else
