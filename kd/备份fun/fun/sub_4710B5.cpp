...
int sub_4710B5(int thisx)
{
    ...
    *(_BYTE*)(thisx + 2580) = 0;
    ...
    sub_4A02E9((_DWORD*)byte_4BDC60, dword_4B9248, 0, 0, dword_4B9248);
    sub_49DB90(v28);
    if (sub_49DA45((_DWORD*)byte_4BDC60, aGraphicKkResul, (int)v28) >= 0)
    {
        sub_49C15E((int)v26);
        v26[0] = v28[0];
        sub_49CC5B((short*)byte_4BDC60, dword_4B9248, v26);
        sub_49DA8A((_DWORD*)byte_4BDC60, v28[0]);
    }
    *(_DWORD*)(thisx + 2528) = sub_43FC18((_DWORD*)dword_4BDB28, pszFileName);
    for (i = 0; i < 4; ++i)
    {
