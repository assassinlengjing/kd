...
UINT sub_44ED4D(UINT thisx)
{
    ...
    if (!*(_BYTE*)(thisx + 2516))
    {
        if (*(_BYTE*)(thisx + 2562))
        {
            if (*(_BYTE*)(thisx + 2562) == 1)
            {
                ...
                else
                {
                    ...
                    if (sub_476DC7(v6, 0))
                    {
                        sub_47652C((int*)&byte_4B9410[108 * *(_DWORD*)(thisx + 2528)], *(_DWORD*)(thisx + 2536));
                        *(_BYTE*)(thisx + 2562) = 2;
        ...
        else
        {
            ...
            *(_DWORD*)(thisx + 2528) += v37;
            ...
            {
                *(_BYTE*)(thisx + 2562) = 1;
                *(_DWORD*)(thisx + 2536) = (char)sub_4768D5((int*)&byte_4B9410[108 * *(_DWORD*)(thisx + 2528)]);
    ...
    v44[2] = 0;
    v44[0] = dword_4B9248;
    sub_49AB05((int)byte_4BDC60, v44);
    v41 = 16;
    v39 = 16;
    if (*(int*)(thisx + 2532) > 0)
    ...
    for (i = *(_DWORD*)(thisx + 2532); i < *(_DWORD*)(thisx + 2532) + 4; ++i)
    {
        ...
        v27 = sub_4768D5((int*)&byte_4B9410[108 * i]);
        ...
        if (v27 >= 0)
        {
            ...
            if (v27 < 1)
            {
                if (!v27)
                {
                    ...
                    for (k = 0; k < 11; ++k)
                    {
                        v11 = sub_4768F5(&byte_4B9410[108 * i], k);
            ...
            else
            {
                ...
                for (m = 0; m < 11; ++m)
                {
                    ...
                    v24 = sub_4768BD(&byte_4B9410[108 * i], m);
                    if (v24 < 0)
                    {
                        switch (v24)
                        {
                    ...
                    {
                        v8 = sub_4768BD(&byte_4B9410[108 * i], m);
            ...
            if (*(_BYTE*)(thisx + 2562) == 2 && *(_DWORD*)(thisx + 2528) == i)
            {
                    ...
                    if (!v27)
                    {
                        ...
                        if (*(_BYTE*)(i + thisx + 2588) == 1)
                        {
                            *(_BYTE*)(thisx + 11 * i + 11264 + *(unsigned __int16*)(thisx + 2 * i + 2564)) = v16;
                            sub_47690D(&byte_4B9410[108 * i], *(_BYTE*)(thisx + 2 * i + 2564), v16);
                ...
                else
                {
                    for (n = -4;
                        n < 16
                        && (n >= 0 || !sub_476A8E((int*)&byte_4B9410[108 * i], n))
                        && (n < 0 || !sub_47646A((int*)&byte_4B9410[108 * i], n));
                        ++n)
                    {
                        ;
                    }
                    ...
                    if (*(_BYTE*)(i + thisx + 2588) == 1 && *(unsigned __int16*)(thisx + 2 * i + 2564) < 0xBu)
                    {
                        ...
                        {
                            if (ii >= 0)
                                v18 = sub_47646A((int*)&byte_4B9410[108 * i], ii);
                            else
                                v18 = sub_476A8E((int*)&byte_4B9410[108 * i], ii);
                            if (v18)
                            {
                                sub_4768A2(&byte_4B9410[108 * i], *(_BYTE*)(thisx + 2 * i + 2564), ii);
