...
unsigned __int16* sub_48D421(int thisx, int a2)
{
    ...
    if (*(_BYTE*)(thisx + 12))
    {
        ...
        {
            sub_49C15E((int)&v27);
            v26 = *(__int16*)(thisx + 72) * sub_446465((char*)byte_4B9B10) / 100;
            if (*(_BYTE*)(thisx + 8) && *(_BYTE*)(thisx + 8) != 1)
            {
                if (*(_BYTE*)(thisx + 8) == 2)
                {
                    ...
                    v29 = *(_DWORD*)(thisx + 144) + sub_4464BA((int)byte_4B9B10) + v3;
                }
            ...
            if (*(_DWORD*)(thisx + 92))
            {
                v25 = (_BYTE*)sub_4741F8((int)byte_4B9B10, *(_DWORD*)(thisx + 104) / 800, *(_DWORD*)(thisx + 108) / 800);
                v24 = sub_446497((int*)byte_4B9B10, *(_DWORD*)(thisx + 104) / 100, *(_DWORD*)(thisx + 108) / 100);
                ...
                if (100 * v24 < *(_DWORD*)(thisx + 112))
                {
                    ...
                    LOBYTE(v23) = sub_4464F6((_DWORD*)byte_4B9B10, *(_DWORD*)(thisx + 104) / 800, *(_DWORD*)(thisx + 108) / 800);
                    sub_49C15E((int)v20);
                    v20[0] = dword_4B9214;
                    v20[1] = v28 - *(_DWORD*)(thisx + 140) - 8;
                    v4 = *(_DWORD*)(thisx + 108) / 100 - v24;
                    v21 = v4 + sub_4464BA((int)byte_4B9B10) - 2;
            ...
            else if (*(unsigned __int8*)(thisx + 48) <= 1u)
            {
                ...
                if (*(_DWORD*)(thisx + 64))
                {
                    v10 = sub_48E0F0(byte_4BDC60, v27);
                ...
                if (*(_DWORD*)(thisx + 68))
                {
                    v8 = sub_48E110((char*)byte_4BDC60, v27);
                    v11 = (240 % v8 != 0) + 240 / v8;
                    if (v29 % v8)
                    {
                        v29 = v29 % v8 - (v29 > 0) * v8;
                ...
                for (i = 0; i < v11; ++i)
                {
                    for (j = 0; j < v9; ++j)
                    {
                        sub_49AB05((int)byte_4BDC60, &v27);
                        v28 += v10;
                    }
                    v28 -= v10 * v9;
                    v29 += v8;
            ...
            {
                v13 = sub_462234((_DWORD*)byte_4B9B10, *(unsigned __int8*)(thisx + 48) - 1, *(_DWORD*)(thisx + 44));
                v14 = sub_46231F((_DWORD*)byte_4B9B10, *(unsigned __int8*)(thisx + 48) - 1);
                v27 = sub_462556((_DWORD*)byte_4B9B10, *(unsigned __int8*)(thisx + 48) - 1 - 2 * (*(unsigned __int8*)(thisx + 48) >= 4u));
                v16 = sub_426590(byte_4B9B10, (*(unsigned __int8*)(thisx + 48) - 2) % 2);
